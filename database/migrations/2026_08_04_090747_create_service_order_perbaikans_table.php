...
return new class extends Migration
{
    ...
    {
        Schema::create('service_order_perbaikans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('jenis_perbaikan_id')->constrained()->onUpdate('cascade')->onDelete('no action');
    ...
    {
        Schema::dropIfExists('service_order_perbaikans');
    }
};
