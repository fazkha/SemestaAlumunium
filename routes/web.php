...
Route::prefix('human-resource')->middleware('auth')->group(function () {
    ...
    Route::post('mitra/store-jabatan/{mitra}', [BrandivjabmitController::class, 'storeJabatan']);
    Route::delete('mitra/delete-jabatan/{jabatan}', [BrandivjabmitController::class, 'deleteJabatan']);
...
Route::prefix('warehouse')->middleware('auth')->group(function () {
    ...
    Route::get('stock-adjustment/print-one-adjust/{id}', [StockAdjustmentController::class, 'printOneAdjust']);
