            ...
            <tbody>
                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span class="text-gray-900 dark:text-gray-400">{{ $data->urutan }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span class="text-gray-900 dark:text-gray-400">{{ $data->standar }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400"
                            ...
                            <div class="flex items-center justify-center">
                                @can('inspect-show')
                                    <a href="{{ route('std-inspect.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('inspect-edit')
                                    <a href="{{ route('std-inspect.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('inspect-delete')
                                    <a href="{{ route('std-inspect.delete', Crypt::Encrypt($data->id)) }}"
