                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-300">
                            <span
                                class="text-gray-900 dark:text-gray-300">{{ $data->stock_opname_details_count }}</span>
                        </td>
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-300"
                            ...
                            <div class="flex items-center justify-center">
                                @can('stopname-create')
                                    <x-anchor-transparent id="print_one_adjust-anchor-{{ Crypt::Encrypt($data->id) }}"
                                        onclick="print_one_adjust('{{ Crypt::Encrypt($data->id) }}')"
                                        title="{{ __('messages.print') }}" class="ml-2 p-2">
                                        <span
                                    ...
                                    <svg id="print_one-icon-{{ Crypt::Encrypt($data->id) }}"
                                        class="hidden size-5 mx-5 mt-4 mb-5" viewBox="0 0 15 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M3.5 12.5H1.5C0.947715 12.5 0.5 12.0523 0.5 11.5V7.5C0.5 6.94772 0.947715 6.5 1.5 6.5H13.5C14.0523 6.5 14.5 6.94772 14.5 7.5V11.5C14.5 12.0523 14.0523 12.5 13.5 12.5H11.5M3.5 6.5V1.5C3.5 0.947715 3.94772 0.5 4.5 0.5H10.5C11.0523 0.5 11.5 0.947715 11.5 1.5V6.5M3.5 10.5H11.5V14.5H3.5V10.5Z"
                                            stroke="currentColor" />
