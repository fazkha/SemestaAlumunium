        ...
        <div class="container mx-auto px-2 sm:px-4 py-2">
            <div class="flex flex-col items-center">
                ...
                <div class="w-3/4 lg:w-1/2 shadow mb-5" role="alert">
                    <form action="{{ route('repair-type.destroy', Crypt::Encrypt($datas->id)) }}" class="block"
                            ...
                            <div class="bg-white border-r-4 border-red-600 w-full p-4">
                                <div>
                                    ...
                                    <div class="flex flex-col md:flex-row gap-2 justify-between">
                                        ...
                                        <x-anchor-secondary href="{{ route('repair-type.index') }}" tabindex="1"
                                            autofocus>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="size-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex flex-col lg:flex-row">
                            <div class="w-full lg:w-1/2 px-2">
                                ...
                                <div class="w-auto pb-4">
                                    <span for="nama"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.repair')</span>
                            ...
                            <div class="w-full lg:w-1/2 px-2 flex flex-col justify-start">
                                <div class="flex flex-row flex-wrap items-center justify-end gap-2 md:gap-4 lg:pt-8">
                                    ...
                                    <x-anchor-secondary href="{{ route('repair-type.index') }}" tabindex="2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M6 18 18 6M6 6l12 12" />
