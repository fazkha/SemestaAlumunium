                    ...
                    <tr>
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400"
                            ...
                            <div class="flex items-center justify-center">
                                @can('inspect-show')
                                    <a href="{{ route('repair-type.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('inspect-edit')
                                    <a href="{{ route('repair-type.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('inspect-delete')
                                    <a href="{{ route('repair-type.delete', Crypt::Encrypt($data->id)) }}"
