        ...
        <div class="w-full px-4 py-2">
            <div class="flex flex-col items-center">
                ...
                <div class="w-full" role="alert">
                    @include('mitra.partials.feedback')
                </div>

                <form id="master-form" action="{{ route('mitra.update', Crypt::Encrypt($datas->id)) }}" method="POST"
                                ...
                                <div class="w-full lg:w-1/2 px-2">
                                    ...
                                    <div class="w-auto pb-4">
                                        <label for="gaji_pokok"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.gapok')
                                    ...
                                    <div class="flex flex-row gap-2">
                                        <div class="w-2/3 pb-4">
                                            <label for="t1_keterangan"
                                                class="block mb-2 font-medium text-primary-600">@lang('messages.tunjangan')</label>
                                            <x-text-input type="text" maxlength="200" name="t1_keterangan"
                                                id="t1_keterangan" tabindex="13"
                                        ...
                                        <div class="w-1/3 pb-4">
                                            <label for="t1_gaji"
                                                class="block mb-2 font-medium text-primary-600">Rp.</label>
                                    ...
                                    <div class="flex flex-row gap-2">
                                        <div class="w-2/3 pb-4">
                                            <label for="t2_keterangan"
                                                class="block mb-2 font-medium text-primary-600">@lang('messages.tunjangan')</label>
                                            <x-text-input type="text" maxlength="200" name="t2_keterangan"
                                                id="t2_keterangan" tabindex="15"
                                                placeholder="{{ __('messages.enter') }} {{ __('messages.tunjangan') }}"
                                    ...
                                    <div class="flex flex-row gap-2">
                                        <div class="w-2/3 pb-4">
                                            <label for="t3_keterangan"
                                                class="block mb-2 font-medium text-primary-600">@lang('messages.tunjangan')</label>
                                            <x-text-input type="text" maxlength="200" name="t3_keterangan"
                                                id="t3_keterangan" tabindex="17"
                                                placeholder="{{ __('messages.enter') }} {{ __('messages.tunjangan') }}"
                                ...
                                <div class="w-full lg:w-1/2 px-2">
                                    ...
                                    <div class="w-auto pb-4">
                                        <label for="rek_nama_bank"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.bankname')</label>
                                        <x-text-input type="text" maxlength="200" name="rek_nama_bank"
                                            id="rek_nama_bank" tabindex="19"
                                    ...
                                    <div class="w-auto pb-4">
                                        <label for="rek_nomor"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.bankaccountnumber')</label>
                                        <x-text-input type="text" maxlength="200" name="rek_nomor" id="rek_nomor"
                                            tabindex="20"
                                    ...
                                    <div class="w-auto pb-4">
                                        <label for="rek_nama_pemilik"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.bankaccountname')</label>
                                        <x-text-input type="text" maxlength="200" name="rek_nama_pemilik"
                                            id="rek_nama_pemilik" tabindex="21"
                            ...
                            <div class="p-4 space-y-2">
                                ...
                                <div
                                        ...
                                        <table id="jabatan_table" class="w-full border-separate border-spacing-2">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="w-1/12">@lang('messages.cart')</th>
                                                    ...
                                                    <td>
                                                        <select name="gerobak_id" id="gerobak_id" tabindex="28"
                                                            ...
                                                            @foreach ($gerobaks as $gerobak)
                                                                <option value="{{ $gerobak->id }}"
                                                                    {{ old('gerobak_id') == $gerobak->id ? 'selected' : '' }}>
                                                                    {{ $gerobak->kode }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <div class="mt-4 mb-4 mr-4 flex flex-row flex-wrap justify-end gap-2 md:gap-4">
                                        ...
                                        <x-anchor-secondary href="{{ route('mitra.index') }}" tabindex="31">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="size-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            $(document).ready(function(e) {
                ...
                deleteDetail = function(detailId) {
                    ...
                    if (confirmation) {
                        ...
                        $.ajax({
                            url: '{{ url('/human-resource/mitra/delete-jabatan') }}' + '/' + detailId,
                            type: 'delete',
                            dataType: 'json',
                            data: {
                                '_token': '{{ csrf_token() }}',
                ...
                $("#submit-detail").on("click", function(e) {
                    e.preventDefault();
                    let key = $('#mitra_id').val();

                    $.ajax({
                        url: '{{ url('/human-resource/mitra/store-jabatan') }}' + '/' + key,
                        type: 'post',
                        dataType: 'json',
