...
<x-app-layout>
    ...
    <form action="{{ route('replacement-type.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                            ...
                            <div class="flex flex-col lg:flex-row">
                                <div class="w-full lg:w-1/2 px-2">
                                    ...
                                    <div class="w-auto pb-4">
                                        <label for="nama"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.gantibaru')</label>
