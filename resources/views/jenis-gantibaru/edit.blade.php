...
<x-app-layout>
    ...
    <form action="{{ route('replacement-type.update', Crypt::Encrypt($datas->id)) }}" method="POST"
            ...
            <div class="w-full px-4 py-2">
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-full" role="alert">
                        @include('jenis-gantibaru.partials.feedback')
                    </div>
                            ...
                            <div class="flex flex-col lg:flex-row">
                                <div class="w-full lg:w-1/2 px-2">
                                    ...
                                    <div class="w-auto pb-4">
                                        <label for="nama"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.replacementtype')</label>
                                        <x-text-input type="text" maxlength="200" name="nama" id="nama"
                                            tabindex="2"
                                            placeholder="{{ __('messages.enter') }} {{ __('messages.replacementtype') }}"
                                ...
                                <div class="w-full lg:w-1/2 px-2 flex flex-col justify-start">
                                    ...
                                    <div class="flex flex-row flex-wrap items-center justify-end gap-2 md:gap-4">
                                        ...
                                        <x-anchor-secondary href="{{ route('replacement-type.index') }}" tabindex="6">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="size-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
