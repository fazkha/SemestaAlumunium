...
@endphp
@section('title', __('messages.repair'))
...
<x-app-layout>
    <div
        ...
        <h1 class="text-xl flex items-center justify-center">
            <a href="{{ route('repair.index') }}" class="flex items-center justify-center">
                ...
                <div class="relative px-2 pt-2">
                    ...
                    <span>@lang('messages.repair')</span>
                </div>
            </a>
        ...
        <div class="w-full px-4 py-2">
            <div class="flex flex-col items-center">
                ...
                <div class="w-full" role="alert">
                    @include('service-perbaikan.partials.feedback')
                </div>

                <form id="master-form" action="{{ route('repair.update', Crypt::Encrypt($datas->id)) }}" method="POST"
                        ...
                        <div class="p-4 space-y-2">
                            ...
                            <div class="flex flex-col lg:flex-row">
                                <div class="w-full lg:w-1/2 px-2">
                                    ...
                                    <div class="w-auto pb-4">
                                        <label for="petugas_repair_id"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.officer')</label>
                                        <select name="petugas_repair_id" id="petugas_repair_id" tabindex="4" required
                                            autofocus
                                            class="w-full block text-sm rounded-lg shadow-md text-gray-700 placeholder-gray-300 border-primary-100 bg-primary-20 dark:placeholder-gray-600 dark:border-primary-800 dark:bg-primary-700 dark:text-gray-400">
                                            <option value="">@lang('messages.choose')...</option>
                                            @foreach ($petugass as $id => $name)
                                                <option value="{{ $id }}"
                                                    {{ $datas->petugas_repair_id == $id ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>

                                        <x-input-error class="mt-2" :messages="$errors->get('petugas_repair_id')" />
                                    </div>
                                ...
                                <div class="w-full lg:w-1/2 px-2 flex flex-col justify-start">
                                    ...
                                    <div class="flex flex-row flex-wrap items-center justify-end gap-2 md:gap-4">
                                        ...
                                        <x-anchor-secondary href="{{ route('repair.index') }}" tabindex="9">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="size-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div
                                    ...
                                    <div class="relative p-2 overflow-x-auto overflow-y-visible">
                                        <table id="order_table" class="w-full border-separate border-spacing-2">
                                            <thead>
                                                <tr>
                                                    <th class="w-1/4">@lang('messages.repairtype')</th>
                                            ...
                                            <tbody id="detailBody">
                                                @include('service-perbaikan.partials.details', [
                                                    $details,
                                                    'viewMode' => false,
                                                ])
                                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="align-top">
                                                        <select id="jenis_perbaikan_id" name="jenis_perbaikan_id"
                                                            required tabindex="12"
                                                            class="w-full block text-sm rounded-lg shadow-md text-gray-700 placeholder-gray-300 border-primary-100 bg-primary-20 dark:placeholder-gray-600 dark:border-primary-800 dark:bg-primary-700 dark:text-gray-400">
                                                            <option value="">@lang('messages.choose')...</option>
                                                            @foreach ($jenis_perbaikans as $id => $name)
                                                                <option value="{{ $id }}">
                                                                    {{ $name }}</option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <div class="mt-4 mb-4 mr-4 flex flex-row flex-wrap justify-end gap-2 md:gap-4">
                                        ...
                                        <x-anchor-secondary href="{{ route('repair.index') }}" tabindex="19">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="size-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            $(document).ready(function(e) {
                ...
                deleteDetail = function(detailId) {
                    ...
                    if (confirmation) {
                        ...
                        $.ajax({
                            url: '{{ url('/service/repair/delete-detail') }}' + '/' + detailId,
                            type: 'delete',
                            dataType: 'json',
                            data: {
                                '_token': '{{ csrf_token() }}',
                ...
                $("#submit-detail").on("click", function(e) {
                    ...
                    $.ajax({
                        url: '{{ url('/service/repair/store-detail') }}' + '/' + key,
                        type: 'post',
                        dataType: 'json',
