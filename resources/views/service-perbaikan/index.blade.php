    ...
    <div class="mx-auto px-4 py-2">
        <div class="flex flex-col items-center">
            ...
            <div class="w-full overflow-x-auto">
                @include('service-perbaikan.partials.filter')
            </div>

            <div id="table-container" class="w-full">
                @include('service-perbaikan.partials.table')
            </div>
            ...
            $("#pp-dropdown, #isactive-dropdown, #customer-dropdown, #petugas-dropdown, #search-tanggal")
                .on(
                    ...
                    function() {
                        ...
                        var newURL = '{{ url('/service/repair') }}';
                        var newState = {
                            page: 'index-service-repair'
                        };
                        ...
                        $.ajax({
                            url: '{{ url('/service/repair/fetchdb') }}' + "/" + xpp + "/" + xisactive + "/" +
