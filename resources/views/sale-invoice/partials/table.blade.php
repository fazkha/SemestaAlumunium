    ...
    @if (count($datas) > 0)
        <div class="py-2">
            <div class="flex flex-row flex-wrap lg:flex-nowrap items-center justify-start gap-2 md:gap-4">
                <x-secondary-button id="print-laporan" class="bg-indigo-700 hover:bg-indigo-800 hover:dark:bg-indigo-950">
...
<div class="my-2 flex flex-row items-center justify-start shadow-md rounded-md border border-solid border-primary-100">
