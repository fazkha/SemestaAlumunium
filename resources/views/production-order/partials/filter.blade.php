<div class="my-2">
    <div class="flex flex-col-reverse md:flex-row gap-4 justify-between">
            ...
            <form id="form-filter">
                ...
                <div class="flex flex-col lg:flex-row justify-start">
                    <div class="flex-row justify-start">
                        ...
                        <div class="relative shadow-md mr-2 mb-2">
                            <span
                                class="w-24 text-xs h-full absolute inset-y-0 left-0 flex items-center px-2 rounded-md border border-primary-100 dark:bg-primary-900 dark:border-primary-800">@lang('messages.productionfinish')</span>
        ...
        <div class="flex flex-col gap-2">
            ...
            @can('prodo-show')
                <div class="hidden w-full p-2 md:p-4 border rounded-md bg-primary-50 border-primary-100">
