            ...
            <tbody>
                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20">
                            <span class="text-gray-900">{{ $data->brandivjab->branch->nama }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20">
                            <span
                                class="text-gray-900">{{ $data->brandivjab->division_id ? $data->brandivjab->division->nama : '-' }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20">
                            <span
                                class="text-gray-900">{{ $data->brandivjab->jabatan->nama . ' ' . $data->brandivjab->keterangan }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20">
                            @php
