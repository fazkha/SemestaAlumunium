                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span
                                class="text-gray-900 dark:text-gray-400">{{ $data->petugas_replacement_id ? $data->petugas_replacement->nama_lengkap : '-' }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400"
                            ...
                            <div class="flex items-center justify-center">
                                @can('perbaikan-show')
                                    <a href="{{ route('replacement.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('perbaikan-edit')
                                    @if ($data->ispackaged == 0)
                                        <a href="{{ route('replacement.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('perbaikan-delete')
                                    @if ($data->ispackaged == 0)
                                        <a href="{{ route('replacement.delete', Crypt::Encrypt($data->id)) }}"
