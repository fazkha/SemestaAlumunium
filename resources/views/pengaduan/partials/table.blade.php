        ...
        <table class="min-w-full leading-normal">
            <thead>
                <tr>
                    ...
                    <th
                        class="w-1/12 px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider border-b border-primary-100 text-gray-600 bg-primary-50 dark:text-gray-400 dark:bg-primary-800 dark:border-primary-800">
                        @lang('messages.date')
                    </th>
                    <th
                        class="w-1/5 px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider border-b border-primary-100 text-gray-600 bg-primary-50 dark:text-gray-400 dark:bg-primary-800 dark:border-primary-800">
                        @lang('messages.complaint')
                    </th>
                    <th
                        class="w-1/4 px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider border-b border-primary-100 text-gray-600 bg-primary-50 dark:text-gray-400 dark:bg-primary-800 dark:border-primary-800">
                        @lang('messages.user')
                    </th>
                    <th
                        class="px-3 py-3 text-center text-xs font-semibold uppercase tracking-wider border-b border-primary-100 text-gray-600 bg-primary-50 dark:text-gray-400 dark:bg-primary-800 dark:border-primary-800">
                    ...
                    <tr>
                        ...
                        <td
                            ...
                            <div class="flex items-center justify-center">
                                <button
                                    @click="openModal = true; modalTitle = '{{ $data->user->name }}'; $refs.imgRef.src = '{{ $data->gambar ? asset($data->lokasi . '/' . $data->gambar) : asset('images/0cd6be830e32f80192d496e50cfa9dbc.jpg') }}'">
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span class="text-gray-900 dark:text-gray-400">{{ $data->aduan }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span class="text-gray-900 dark:text-gray-400">{{ $data->user->name }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400"
                            ...
                            <div class="flex items-center justify-center">
                                @can('pengaduan-show')
                                    <a href="{{ route('complaint.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('pengaduan-edit')
                                    <a href="{{ route('complaint.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('pengaduan-delete')
                                    <a href="{{ route('complaint.delete', Crypt::Encrypt($data->id)) }}"
