...
<x-app-layout>
    ...
    <form action="{{ route('cashflow.update', Crypt::Encrypt($datas[0]->id)) }}" method="POST"
                                            ...
                                            <tbody>
                                                ...
                                                @if ($datas[0]->count() > 0)
                                                    @foreach ($datas as $key => $data)
                                                        @php
                                                            $subgroup = $data->nama_subgroup;
                                                        @endphp
                                                        @if ($group !== $data->nama_group)
                                                            @php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-top" colspan="2">
                                                                    {{ strtoupper($data->nama_group) }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        <tr>
                                                            <td class="align-top text-center">
                                                                <x-text-span>{{ $data->kelompok->urutan }}</x-text-span>
                                                            </td>
                                                            <td class="align-top">
                                                                <x-text-span>{{ $data->kelompok->nama }}</x-text-span>
                                                            </td>
                                                            <td class="align-top text-right">
                                                                <x-text-span>{{ Str::accountingNumber($data->nominal) }}</x-text-span>
                                                            </td>
                                                        </tr>
                                                        @php
                                                            $total1 += $data->nominal;
                                                            $total2 += $data->nominal;
                                                            $nextData = $datas->get($key + 1);
                                                            $nextSubgroup = $nextData?->nama_subgroup;
                                                            $nextTotalgroup = $nextData?->nama_group;
                                                        @endphp
                                                        @if ($subgroup !== $nextSubgroup)
                                                            <tr>
                                                                ...
                                                                <td class="align-top text-right pr-3">
                                                                    {{ Str::accountingNumber($total1) }}
                                                                </td>
                                                            </tr>
                                                            @php
                                                                $total1 = 0;
                                                            @endphp
                                                        @endif
                                                        @if ($group !== $nextTotalgroup)
                                                            <tr>
                                                                <td class="align-top text-right" colspan="2">
                                                                    KAS BERSIH {{ strtoupper($data->nama_group) }}
                                                                </td>
                                                                <td class="align-top text-right pr-3">
                                                                    {{ Str::accountingNumber($total2) }}
                                                                </td>
                                                            </tr>
                                                            @php
                                                                $totalgroup[] = $total2;
                                                    ...
                                                    @foreach ($cfgroups as $key => $cfgroup)
                                                        <tr>
                                                            <td class="align-top text-center">
                                                                <x-text-span>{{ $i + 1 }}</x-text-span>
                                                            </td>
                                                            <td class="align-top">
                                                                <x-text-span>Kas Bersih
                                                                    {{ $cfgroup->nama }}</x-text-span>
                                                            </td>
                                                            <td class="align-top text-right">
                                                                <x-text-span>{{ Str::accountingNumber($totalgroup[$i]) }}</x-text-span>
                                                            </td>
                                                        </tr>
                                                        @php
                                                            $i += 1;
                                                    ...
                                                    <tr>
                                                        <td class="align-top text-right" colspan="2">
                                                            {{ $saved_total3 >= 0 ? 'KENAIKAN' : 'PENURUNAN' }} KAS
                                                        </td>
                                                        <td class="align-top text-right pr-3">
                                                            {{ Str::accountingNumber($saved_total3) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="align-top text-right pb-2 border-b border-primary-600 dark:border-primary-700"
                                                            colspan="2">
                                                            KAS AWAL
                                                        </td>
                                                        <td
                                                            class="align-top text-right pr-3 pb-2 border-b border-primary-600 dark:border-primary-700">
                                                            {{ Str::accountingNumber($kas_awal) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="align-top text-right" colspan="2">
                                                        ...
                                                        <td class="align-top text-right pr-3">
                                                            {{ Str::accountingNumber($saved_total3 + $kas_awal) }}
                                                        </td>
                                                    </tr>
                                                @endif
                                            </tbody>
