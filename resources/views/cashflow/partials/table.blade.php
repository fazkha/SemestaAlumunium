        ...
        <table class="min-w-full leading-normal">
            <thead>
                <tr>
                    ...
                    <th
                        class="px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider border-b border-primary-100 text-gray-600 bg-primary-50 dark:text-gray-400 dark:bg-primary-800 dark:border-primary-800">
                        @lang('messages.kas_awal')
                    </th>
                    <th
                        class="px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider border-b border-primary-100 text-gray-600 bg-primary-50 dark:text-gray-400 dark:bg-primary-800 dark:border-primary-800">
                        @lang('messages.kas_akhir')
                    </th>
                    <th
                        class="px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider border-b border-primary-100 text-gray-600 bg-primary-50 dark:text-gray-400 dark:bg-primary-800 dark:border-primary-800">
                        &nbsp;
            ...
            <tbody>
                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span class="text-gray-900 dark:text-gray-400">{{ $data->tahun }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span class="text-gray-900 dark:text-gray-400">{{ $data->bulan }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span
                                class="text-gray-900 dark:text-gray-400">{{ number_format($data->kas_awal, 0, ',', '.') }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400">
                            <span
                                class="text-gray-900 dark:text-gray-400">{{ number_format($data->kas_akhir, 0, ',', '.') }}</span>
                        </td>
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 text-gray-700 dark:bg-primary-900 dark:border-primary-800 dark:text-gray-400"
                            ...
                            <div class="flex items-center justify-center">
                                @can('laporan-show')
                                    <a href="{{ route('cashflow.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('laporan-edit')
                                    @if ($data->isclosed == 0)
                                        <a href="{{ route('cashflow.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('laporan-delete')
                                    @if ($data->isclosed == 0)
                                        <a href="{{ route('cashflow.destroy', Crypt::Encrypt($data->id)) }}"
