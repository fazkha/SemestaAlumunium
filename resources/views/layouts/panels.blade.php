...
<section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
    ...
    class="fixed inset-y-0 right-0 z-20 w-full max-w-xs bg-primary-20 shadow-xl sm:max-w-md focus:outline-none"
    ...
    <div class="flex flex-col h-screen">
        <!-- Panel header -->
        <div
            class="flex flex-col items-center justify-center flex-shrink-0 px-4 py-8 space-y-4 border-b border-primary-100">
            ...
            <h2 id="settinsPanelLabel" class="text-xl font-medium text-gray-500">@lang('messages.setting')</h2>
        </div>
        <!-- Content -->
        <div class="flex-1 overflow-hidden hover:overflow-y-auto">
            <!-- Theme -->
            <div class="p-4 space-y-1 md:p-8">
                <h6 class="text-lg font-medium text-gray-400">@lang('messages.theme')</h6>
                <div class="flex items-center space-x-8">
                    <!-- Light button -->
                    <button @click="setLightTheme"
                        class="flex items-center justify-center px-4 py-2 space-x-4 transition-colors border rounded-md hover:text-gray-900 hover:border-gray-900 focus:outline-none focus:ring focus:ring-primary-400 focus:ring-offset-2"
                        :class="{
                            'text-gray-500': isDark,
                            'border-gray-900 text-gray-900': !isDark
                        }">
                        <span>
            ...
            <!-- Colors -->
            <div class="p-4 space-y-1 md:p-8">
                <h6 class="text-lg font-medium text-gray-400">@lang('messages.colors')</h6>
            ...
            <!-- Language -->
            <div class="p-4 space-y-1 md:p-8">
                <h6 class="text-lg font-medium text-gray-400">@lang('messages.language')</h6>
                <div class="flex items-center space-x-8">
                    <!-- English button -->
                    <button @click="setEnLang"
                        class="flex items-center justify-center px-4 py-2 space-x-4 transition-colors border rounded-md hover:text-gray-900 hover:border-gray-900 focus:outline-none focus:ring focus:ring-primary-400 focus:ring-offset-2"
                        :class="{
                            'text-gray-500': !isEnLang,
                            'border-gray-900 text-gray-900': isEnLang
                        }">
                        <span>
...
<section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
    ...
    class="fixed inset-y-0 z-20 w-full max-w-xs bg-primary-20 sm:max-w-md focus:outline-none">
    ...
    <div class="flex flex-col h-screen" x-data="{ activeTabe: 'action' }">
        ...
        <div class="flex-shrink-0">
            <div
                class="flex items-center justify-between px-4 pt-4 border-b border-primary-100">
                        ...
                        <button name="restockButton"
                            ...
                            <div class="flex px-4 space-x-4">
                                <div class="relative flex-shrink-0">
                                    <span
                                        class="inline-block p-2 overflow-visible rounded-full bg-primary-50 text-primary-500">
                                    ...
                                    <div
                                        class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2">
                                    </div>
                                </div>
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <p class="text-sm font-normal text-primary-500">
                                        {!! $notif->message !!}
                                    </p>
                ...
                {{-- <template x-for="i in 10" x-key="i">
                    <a href="#" class="block">
                        <div class="flex px-4 space-x-4">
                            ...
                            <div class="flex-1 overflow-hidden">
                                <h5 class="text-sm font-semibold text-gray-600">User
                                </h5>
                                <p class="text-sm font-normal text-gray-400 truncate">
                                    Release new version "Dashboard"
                                </p>
                                <span class="text-sm font-normal text-gray-400"> 20d
                                    ago </span>
                            </div>
                        </div>
                    </a>
...
<section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
    ...
    class="fixed inset-y-0 z-20 w-full max-w-xs bg-primary-20 shadow-xl sm:max-w-md focus:outline-none">
    <div class="absolute right-0 p-2 transform translate-x-full">
        <!-- Close button -->
    ...
    <div class="flex flex-col h-screen">
        ...
        <div
            class="relative flex-shrink-0 px-4 py-8 text-gray-400 border-b border-primary-100 focus-within:text-gray-700">
            ...
            <input x-ref="searchInput" name="searchInput" type="text"
                class="w-full py-2 pl-10 pr-4 border border-primary-100 rounded-full focus:outline-none focus:ring"
                placeholder="Search..." />
        </div>
        ...
        <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
            ...
            <a href="#" class="flex space-x-4">
                ...
                <div class="flex-1 max-w-xs overflow-hidden">
                    <h4 class="text-sm font-semibold text-gray-600">Header</h4>
                    <p class="text-sm font-normal text-gray-400 truncate">
                        Lorem ipsum dolor, sit amet consectetur.
                    </p>
                    <span class="text-sm font-normal text-gray-400"> Post </span>
                </div>
            </a>
            <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                ...
                <div class="flex-1 max-w-xs overflow-hidden">
                    <h4 class="text-sm font-semibold text-gray-600">User</h4>
                    <p class="text-sm font-normal text-gray-400 truncate">
                        Last activity 3h ago.
                    </p>
                    <span class="text-sm font-normal text-gray-400"> Offline </span>
                </div>
            </a>
            <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                ...
                <div class="flex-1 max-w-xs overflow-hidden">
                    <h4 class="text-sm font-semibold text-gray-600">Dashboard</h4>
                    <p class="text-sm font-normal text-gray-400 truncate">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    </p>
                    <span class="text-sm font-normal text-gray-400"> Updated 3h ago.
                    </span>
                </div>
            </a>
            <template x-for="i in 10" x-key="i">
                <a href="#" class="flex space-x-4">
                    ...
                    <div class="flex-1 max-w-xs overflow-hidden">
                        ...
                        <span class="text-sm font-normal text-gray-400"> Updated 3h
                            ago. </span>
                    </div>
                </a>
            </template>
