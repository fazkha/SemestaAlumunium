...
<header class="relative bg-primary-20 dark:bg-primary-900">
    <div class="flex items-center justify-between p-2 border-b border-primary-100 dark:border-primary-800">
        ...
        <button @click="isMobileMainMenuOpen = !isMobileMainMenuOpen"
            ...
            <span aria-hidden="true">
                <svg class="size-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
        ...
        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
            ...
            <button aria-hidden="true" class="relative focus:outline-none" x-cloak @click="toggleTheme">
                ...
                <div class="absolute top-0 left-0 inline-flex items-center justify-center w-6 h-6 transition-all duration-150 transform scale-110 rounded-full shadow-sm border border-primary-100"
                    ...
                    <svg x-show="isDark" class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path
    ...
    <!-- Mobile main manu -->
    <div class="border-b border-primary-100 md:hidden dark:border-primary-700" x-show="isMobileMainMenuOpen"
        ...
        <nav aria-label="Main" class="px-2 py-4 space-y-2">
            ...
            @canany(['pengaduan-list', 'inspect-create', 'gantibaru-list', 'inspect-list', 'perawatan-list',
                'perbaikan-list'])
                @if (config('custom.menu_pelayanan') == true)
                    ...
                    substr(request()->getRequestUri(), 0, 18) == '/service/complaint'
                        ? '{isActive: true, open: true, currentlyOpen: "' . $controllerName . '"}'
                        : '{isActive: false, open: false, currentlyOpen: ""}' }}">
                        <a href="#" @click="$event.preventDefault(); open = !open"
                            class="flex items-center p-2 text-gray-600 transition-colors rounded-md dark:text-lightdark hover:bg-primary-100 dark:hover:bg-primary dark:hover:text-primary-900"
                        ...
                        @can('pengaduan-list')
                            <div x-show="open"
                                ...
                                <a href="{{ route('complaint.index') }}" role="menuitem"
                                    ...
                                    <span class="flex flex-row gap-1"
                                        ...
                                        <svg fill="currentColor" class="size-5" viewBox="-1 0 19 19"
                                            xmlns="http://www.w3.org/2000/svg" class="cf-icon-svg">
                                            <path
                        ...
                        @can('inspect-create')
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="service">
                                <a href="{{ route('std-inspect.index') }}" role="menuitem"
                                    class="block p-2 mt-3 text-sm text-gray-500 transition-colors duration-200 rounded-md dark:text-lightdark hover:bg-primary-100 dark:hover:bg-primary dark:hover:text-primary-900">
                                    <span class="flex flex-row gap-1"
                                        :class="{
                                            'border-b border-b-1 border-primary-100 dark:border-primary': currentlyOpen ==
                                                'stdinspect'
                        ...
                        @can('inspect-list')
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="service">
                                <a href="{{ route('inspect.index') }}" role="menuitem"
                                    class="block p-2 text-sm text-gray-500 transition-colors duration-200 rounded-md dark:text-lightdark hover:bg-primary-100 dark:hover:bg-primary dark:hover:text-primary-900">
                                    <span class="flex flex-row gap-1"
                                        :class="{
                                            'border-b border-b-1 border-primary-100 dark:border-primary': currentlyOpen ==
                    ...
                    substr(request()->getRequestUri(), 0, 17) == '/production/order'
                        ...
                        <a href="#" @click="$event.preventDefault(); open = !open"
                            ...
                            <span aria-hidden="true">
                                <svg class="w-5 h-5" fill="currentColor" version="1.1" id="Capa_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    x="0px" y="0px" viewBox="0 0 491.1 491.1"
