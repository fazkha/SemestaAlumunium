                    ...
                    <div class="p-4 space-y-2">
                        ...
                        <div class="flex flex-col lg:flex-row">
                            <div class="w-full lg:w-1/2 px-2">
                                ...
                                <div class="w-auto pb-4">
                                    <span for="kode"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.suppliercode')</span>
                                    <x-text-span>{{ $datas->kode }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="nama"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.suppliername')</span>
                                    <x-text-span>{{ $datas->nama }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="alamat"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.supplieraddress')</span>
