    ...
    <div class="flex flex-col-reverse md:flex-row gap-4 justify-between">
        <div
            ...
            <div class="flex flex-col lg:flex-row justify-start">
                ...
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        <span
                            class="w-24 text-xs h-full absolute inset-y-0 left-0 flex items-center px-2 rounded-md border border-primary-100 dark:bg-primary-900 dark:border-primary-800">@lang('messages.propinsi')</span>
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        <span
                            class="w-24 text-xs h-full absolute inset-y-0 left-0 flex items-center px-2 rounded-md border border-primary-100 dark:bg-primary-900 dark:border-primary-800">@lang('messages.kabupaten')</span>
        ...
        <div class="flex flex-col gap-2">
            <div class="flex flex-row flex-wrap gap-2">
                ...
                @can('delivery-show')
                    <x-secondary-button id="print-rekap" class="bg-indigo-700 hover:bg-indigo-800 hover:dark:bg-indigo-950">
