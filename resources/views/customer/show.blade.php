                    ...
                    <div class="p-4 space-y-2">
                        ...
                        <div class="flex flex-col lg:flex-row">
                            <div class="w-full lg:w-1/2 px-2">
                                ...
                                <div class="flex flex-row gap-2">
                                    <div class="w-1/3 pb-4">
                                        <span for="customer_group_id"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.customergroup')</span>
                                        <x-text-span>{{ $datas->customer_group->nama }}</x-text-span>
                                    </div>

                                    <div class="w-2/3 pb-4">
                                        <span for="customer_group_id"
                                            class="block mb-2 font-medium text-primary-600">@lang('messages.relatedbranch')</span>
                                ...
                                <div class="w-auto pb-4">
                                    <span for="kode"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.customercode')</span>
                                    <x-text-span>{{ $datas->kode }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="nama"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.customername')</span>
                                    <x-text-span>{{ $datas->nama }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="alamat"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.customeraddress')</span>
                                    <x-text-span>{{ $datas->alamat }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="propinsi"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.propinsi')</span>
                                    <x-text-span>{{ $datas->propinsi->nama }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="kabupaten"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.kabupaten')</span>
                                    <x-text-span>{{ $datas->kabupaten->nama }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="kecamatan"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.kecamatan')</span>
                            ...
                            <div class="w-full lg:w-1/2 px-2 flex flex-col justify-start">
                                <div class="w-auto pb-4">
                                    <span for="tanggal_gabung"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.joindate')</span>
                                    <x-text-span>{{ date('d/m/Y', strtotime($datas->tanggal_gabung)) }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="kontak_nama"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.contactname')</span>
                                    <x-text-span>{{ $datas->kontak_nama }}</x-text-span>
                                </div>

                                <div class="w-auto pb-4">
                                    <span for="kontak_telpon"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.contactphone')</span>
