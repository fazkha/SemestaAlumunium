                            ...
                            <div class="w-full lg:w-1/2 px-2 flex flex-col justify-start">
                                <div class="w-auto pb-4">
                                    <span for="tanggal_terima"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.receiptdate')</span>
                                ...
                                <div class="w-auto pb-4 lg:pb-12">
                                    <span for="keterangan_terima"
                                        class="block mb-2 font-medium text-primary-600">@lang('messages.receiptdescription')</span>
