...
<x-app-layout>
                                    ...
                                    <div class="w-auto pb-4 lg:pb-12">
                                        @if ($count_details == 0)
                                            <label for="copy_recipe"
                                                class="block mb-2 font-medium text-primary-600">@lang('messages.copyfrom')</label>
                                            <x-text-span>
  ...
  "searchClasses": "block w-full py-1.5 sm:py-2 px-3 sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 text-gray-700 dark:text-gray-300 border-primary-100 bg-primary-50 dark:bg-primary-900 before:absolute before:inset-0 before:z-1",
  ...
  "optionClasses": "py-2 px-4 w-full text-sm text-gray-800 dark:text-gray-500 cursor-pointer hover:bg-primary-50 dark:hover:bg-primary-800 rounded-lg focus:outline-hidden focus:bg-primary-50 dark:focus:bg-primary-800",
