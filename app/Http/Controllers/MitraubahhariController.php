...
class MitraubahhariController extends Controller implements HasMiddleware
{
    ...
    public function index(Request $request)
    {
        ...
        $datas = MitraUbahHari::join('larisma7_db01.branches', 'larisma7_db01.branches.id', '=', 'mitra_ubah_haris.branch_id')
            ->join('larisma7_db01.users', 'larisma7_db01.users.id', '=', 'mitra_ubah_haris.user_id')
            ->select('mitra_ubah_haris.*', 'larisma7_db01.branches.nama as branch_nama', 'larisma7_db01.users.name as user_nama');
